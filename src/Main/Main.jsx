import { attention, jar3, mainImg2, minus, plus, rupee } from "../assets/Images/Images";
import Buy from "./Buy";
    ...
    <div className="w-full max-w-[102rem] md:max-h-[50rem] overflow-x-hidden md:overflow-hidden md:pb-7 md:px-[3rem] h-screen flex flex-col justify-between gap-5 md:justify-start  items-center">
      <div className="upper relative z-10 md:relative h-full md:h-screen flex flex-col md:flex-row md:justify-between justify-center mt-[3rem] md:mt-[8rem] md:items-start items-center w-full">
        ...
        <div className="Image animate-float md:animate-none md:absolute w-[20rem] md:w-[50rem] md:-top-[6rem] md:left-1/2 md:transform md:-translate-x-1/2 ">
          <img src={mainImg2} className="w-[100%] md:block hidden -z-10" alt="" />
          <img src={jar3} className="w-[100%] md:hidden -z-10" alt="" />
        </div>
        <div className="Quantity z-20 flex flex-col justify-center items-center md:items-end gap-5">
