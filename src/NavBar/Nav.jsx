...
export default function Nav() {
  ...
  return (
    <div className="w-full z-50 flex top-7 transition-all justify-center items-center min-h-7 fixed bg-transparent">
      <div className="container bg-transparent px-4 backdrop-blur-lg py-2 rounded-full w-full flex justify-between items-center">
      <div className="Logo">
