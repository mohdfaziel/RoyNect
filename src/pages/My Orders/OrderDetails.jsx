...
function OrderDetails() {
  ...
  return (
    <>
      <SEO 
        title="Order Details"
        description="View detailed information about your RoyNect Kashmiri honey and Apis Cerana honey order. Track delivery status, view product details, and manage your premium honey purchase from Bhadarwah."
        keywords="order details, order tracking, honey order, RoyNect honey, Kashmiri honey, Apis cerana honey, Bhadarwah honey, order status"
