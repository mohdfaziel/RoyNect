  ...
  return (
    <>
      <SEO 
        ...
        description="RoyNect admin dashboard for managing premium Kashmiri honey and Apis Cerana honey products, orders, and customer information."
        keywords="admin dashboard, RoyNect honey, Kashmiri honey, Apis cerana honey, Bhadarwah honey, honey management"
