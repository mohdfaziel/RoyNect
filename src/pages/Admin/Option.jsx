...
function Option({title,logo1,logo2,page,setPage}) {
  return (
    <div onClick={()=>setPage(title)} className={`flex cursor-pointer transition-all justify-start md:pl-4 items-center gap-2 md:w-40 p-2 md:py-2 text-base font-semibold rounded-full  ${page===title ? "bg-Adark1 text-white": "text-slate-900 "} `}>
